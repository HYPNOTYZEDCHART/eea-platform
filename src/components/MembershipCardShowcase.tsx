...
export default function MembershipCardShowcase() {
  ...
  const perks = [
    ...
    },
    {
      ...
      desc: "Offres réservées auprès de nos 45+ partenaires institutionnels.",
    },
    {
  ...
  return (
    <section id="carte" className="relative py-24 sm:py-32 bg-[#08142c] overflow-hidden border-t border-white/5">
